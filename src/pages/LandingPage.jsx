        ...
        <>
            ...
            <div className="intro_roll">
                <div className="intro_roll_text">
                    ...
                    <p>Quizzes help student learn and engage with subjects in a fun and challenging wa, expanding general Knowledge and encourage critial thinking.</p>
            ...
            <div className="stat_figures">
                <div className="stat_figures_roll">
                    ...
                    <div className="stat_text">
                        <p>
                            <span>+21</span>
                            <span className="stat_fig_text">Use Our Quizzes to Assess Grades</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="section_two">
                <div className="section_intro_text">
                    <div>
                        <h1>Explore <span>+4,521</span> Quizzes</h1>
                        <p>Quizzes on a Wide Range of Topics, Created by the Best Teachers in the world</p>
                    </div>
                </div>
